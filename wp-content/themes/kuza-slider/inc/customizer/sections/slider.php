...
$wp_customize->add_section( 'section_featured_slider',
	array(
		'title'      => __( 'Banner Section', 'kuza-slider' ),
		'capability' => 'edit_theme_options',
		'panel'      => 'home_page_panel',
		'active_callback' => 'kuza_slider_slider_design_enable',
		)
);
...
$wp_customize->add_control( new Kuza_Slider_Switch_Control( $wp_customize, 'theme_options[disable_featured-slider_section]',
    array(
		'label' 	=> __('Disable Slider Section', 'kuza-slider'),
...
$wp_customize->add_control( 'theme_options[slider_arrow_enable]', array(
	'label'             => esc_html__( 'Enable Slider Arrow', 'kuza-slider' ),
	'section'           => 'section_featured_slider',
	'type'              => 'checkbox',
	'active_callback' => 'kuza_slider_slider_active',
) );
...
$wp_customize->add_control( 'theme_options[slider_autoplay_enable]', array(
	'label'             => esc_html__( 'Enable Slider Autoplay', 'kuza-slider' ),
	'section'           => 'section_featured_slider',
	'type'              => 'checkbox',
	'active_callback' => 'kuza_slider_slider_active',
) );
...
$wp_customize->add_control( 'theme_options[slider_infinite_enable]', array(
	'label'             => esc_html__( 'Enable Slider Slide Infinite', 'kuza-slider' ),
	'section'           => 'section_featured_slider',
	'type'              => 'checkbox',
	'active_callback' => 'kuza_slider_slider_active',
) );
...
$wp_customize->add_control( 'theme_options[slider_fade_enable]', array(
	'label'             => esc_html__( 'Enable Slider Fade Effect', 'kuza-slider' ),
	'section'           => 'section_featured_slider',
	'type'              => 'checkbox',
	'active_callback' => 'kuza_slider_slider_active',
) );
...
$wp_customize->add_control( 'theme_options[slider_title_enable]', array(
	'label'             => esc_html__( 'Enable Slider Title', 'kuza-slider' ),
	'section'           => 'section_featured_slider',
	'type'              => 'checkbox',
	'active_callback' => 'kuza_slider_slider_active',
) );
...
$wp_customize->add_control( 'theme_options[slider_posted_on_enable]', array(
	'label'             => esc_html__( 'Enable Author & Date', 'kuza-slider' ),
	'section'           => 'section_featured_slider',
	'type'              => 'checkbox',
	'active_callback' => 'kuza_slider_slider_active',
) );
...
$wp_customize->add_control('theme_options[slider_speed]', 
	array(
	'label'       => __('Slider Speed', 'kuza-slider'),
	'description' => __('Slider Speed Default speed 800', 'kuza-slider'),
	'section'     => 'section_featured_slider',   
...
$wp_customize->add_control( new Kuza_Slider_Switch_Control( $wp_customize, 'theme_options[slider_dot]',
    array(
		'label' 	=> __('Disable Slider Dots', 'kuza-slider'),
		'section'    			=> 'section_featured_slider',
		'on_off_label' 		=> kuza_slider_switch_options(),
		'active_callback' => 'kuza_slider_slider_active',
    )
...
$wp_customize->add_control('theme_options[number_of_sr_items]', 
	array(
	'label'       => __('Number Of Slides', 'kuza-slider'),
	'description' => __('Save & Refresh the customizer to see its effect. Maximum is 24.', 'kuza-slider'),
	'section'     => 'section_featured_slider',   
...
for( $i=1; $i<=$number_of_sr_items; $i++ ){
	...
	$wp_customize->add_control('theme_options[slider_page_'.$i.']', 
		array(
		'label'       => sprintf( __('Select Page #%1$s', 'kuza-slider'), $i),
		'section'     => 'section_featured_slider',   
	...
	$wp_customize->add_control('theme_options[slider_custom_btn_text_' . $i . ']', 
		array(
		'label'       => sprintf( __('Button Label %d', 'kuza-slider'),$i ),
		'section'     => 'section_featured_slider',   
	...
	$wp_customize->add_control( new Kuza_Slider_Customize_Horizontal_Line( $wp_customize, 'theme_options[slider_hr_'. $i .']',
		array(
			'section'         => 'section_featured_slider',
			'active_callback' => 'kuza_slider_slider_active',
			'type'			  => 'hr',
...
$wp_customize->add_control('theme_options[slider_alt_custom_btn_text]', 
	array(
	'label'       => __('Alternative Button Label', 'kuza-slider'),
	'section'     => 'section_featured_slider',   
...
$wp_customize->add_control('theme_options[slider_alt_custom_btn_url]', 
	array(
	'label'       => __('Alternative Button Url', 'kuza-slider'),
	'section'     => 'section_featured_slider',   
...
$wp_customize->add_control( new Kuza_Slider_Switch_Control( $wp_customize, 'theme_options[disable_blog_banner_section]',
    array(
		'label' 			=> __('Disable Blog Header Section', 'kuza-slider'),
		'description' 		=> __('If you want only header image then disable featured slider and actiove this option.', 'kuza-slider'),
		'section'    		=> 'section_featured_slider',
		'on_off_label' 		=> kuza_slider_switch_options(),
    )
) );