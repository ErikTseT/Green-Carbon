( function( $, api ) {
    ...
    api.controlConstructor['kuza-slider-repeater-text'] = api.Control.extend({
        ...
        // upsell 
    api.sectionConstructor['kuza-slider-upsell'] = api.Section.extend( {
    ...
    wp.customize.bind('ready', function() {
         ...
         // Sortable sections
        jQuery( 'ul.kuza-slider-sortable-list' ).sortable({
            handle: '.kuza-slider-drag-handle',
            axis: 'y',
            update: function( e, ui ){
                jQuery('input.kuza-slider-sortable-input').trigger( 'change' );
            }
        });

        // Sortable sections
        jQuery( "body" ).on( 'hover', '.kuza-slider-drag-handle', function() {
            jQuery( 'ul.kuza-slider-sortable-list' ).sortable({
                handle: '.kuza-slider-drag-handle',
                axis: 'y',
                update: function( e, ui ){
        ...
        jQuery( "body" ).on( 'change', 'input.kuza-slider-sortable-input', function() {
            /* Get the value, and convert to string. */
            this_checkboxes_values = jQuery( this ).parents( 'ul.kuza-slider-sortable-list' ).find( 'input.kuza-slider-sortable-input' ).map( function() {
                return this.value;
            }).get().join( ',' );

            /* Add the value to hidden input. */
            jQuery( this ).parents( 'ul.kuza-slider-sortable-list' ).find( 'input.kuza-slider-sortable-value' ).val( this_checkboxes_values ).trigger( 'change' );

        });

        // Deep linking for counter section to about section.
        jQuery('.kuza-slider-edit').click(function(e) {
            e.preventDefault();
...
*/
 jQuery(document).ready(function($) {
    // $('#kuza-slider-img-container li label img').click(function(){       
    //     $('#kuza-slider-img-container li').each(function(){
    //         $(this).find('img').removeClass ('kuza-slider-radio-img-selected') ;
    //     });
    //     $(this).addClass ('kuza-slider-radio-img-selected') ;
    // }); 
    ...
    $( document ).on( 'click', '.customize_multi_add_field', kuza_slider_customize_multi_add_field )
        .on( 'change', '.customize_multi_single_field', kuza_slider_customize_multi_single_field )
        .on( 'click', '.customize_multi_remove_field', kuza_slider_customize_multi_remove_field )
    ...
    $('#customize-control-theme_options-layout_options_blog #kuza-slider-img-container li label img').click(function(){      
        $('#customize-control-theme_options-layout_options_blog #kuza-slider-img-container li').each(function(){
            $(this).find('img').removeClass ('kuza-slider-radio-img-selected') ;
        });
        $(this).addClass ('kuza-slider-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_archive #kuza-slider-img-container li label img').click(function(){       
        $('#customize-control-theme_options-layout_options_archive #kuza-slider-img-container li').each(function(){
            $(this).find('img').removeClass ('kuza-slider-radio-img-selected') ;
        });
        $(this).addClass ('kuza-slider-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_page #kuza-slider-img-container li label img').click(function(){      
        $('#customize-control-theme_options-layout_options_page #kuza-slider-img-container li').each(function(){
            $(this).find('img').removeClass ('kuza-slider-radio-img-selected') ;
        });
        $(this).addClass ('kuza-slider-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_single #kuza-slider-img-container li label img').click(function(){        
        $('#customize-control-theme_options-layout_options_single #kuza-slider-img-container li').each(function(){
            $(this).find('img').removeClass ('kuza-slider-radio-img-selected') ;
        });
        $(this).addClass ('kuza-slider-radio-img-selected') ;
    });    

    function kuza_slider_customize_multi_add_field(e) {
        ...
        e.preventDefault();
            ...
            kuza_slider_customize_multi_write( $control );
    }

    function kuza_slider_customize_multi_single_field() {
        var $control = $( this ).parents( '.customize_multi_input' );
        kuza_slider_customize_multi_write( $control );
    }

    function kuza_slider_customize_multi_remove_field(e) {
        e.preventDefault();
        var $this = $( this );
        var $control = $this.parents( '.customize_multi_input' );
        $this.parent().remove();
    ...
    function kuza_slider_customize_multi_write( $element) {
