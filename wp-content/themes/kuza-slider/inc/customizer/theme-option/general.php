...
'title'       => __('General Setting', 'kuza-slider'),
...
$wp_customize->add_setting( 'theme_options[disable_homepage_content_section]',
	...
	$wp_customize->add_control( new Kuza_Slider_Switch_Control( $wp_customize, 'theme_options[disable_homepage_content_section]',
	    array(
			'label' 			=> __('Enable/Disable Static Homepage Content Section', 'kuza-slider'),
			'description' => __('This option is only work on Static HomePage ', 'kuza-slider'),
...
$wp_customize->add_control(new Kuza_Slider_Image_Radio_Control($wp_customize, 'theme_options[layout_options_blog]', 
	array(		
	'label' 	=> __('Layout Option For Blog', 'kuza-slider'),
...
$wp_customize->add_control(new Kuza_Slider_Image_Radio_Control($wp_customize, 'theme_options[layout_options_archive]', 
	array(		
	'label' 	=> __('Layout Option For Archive', 'kuza-slider'),
	'section' 	=> 'section_general',
...
$wp_customize->add_control(new Kuza_Slider_Image_Radio_Control($wp_customize, 'theme_options[layout_options_page]', 
	array(		
	'label' 	=> __('Layout Option For Pages', 'kuza-slider'),
	'section' 	=> 'section_general',
...
$wp_customize->add_control(new Kuza_Slider_Image_Radio_Control($wp_customize, 'theme_options[layout_options_single]', 
	array(		
	'label' 	=> __('Layout Option For Single Posts', 'kuza-slider'),
	'section' 	=> 'section_general',
...
$wp_customize->add_setting( 'theme_options[excerpt_length]', array(
	...
	'sanitize_callback' => 'kuza_slider_sanitize_positive_integer',
) );
$wp_customize->add_control( 'theme_options[excerpt_length]', array(
	'label'       => esc_html__( 'Excerpt Length', 'kuza-slider' ),
	'description' => esc_html__( 'in words', 'kuza-slider' ),
	'section'     => 'section_general',
	'type'        => 'number',
