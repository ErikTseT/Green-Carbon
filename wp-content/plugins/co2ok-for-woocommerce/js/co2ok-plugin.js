...
var Co2ok_JS = function () {
    ...
    return {
        PlaceButton: function () {
            let button      = document.querySelector('.co2ok_container');
        ...
        Init: function () {
            ...
            jQuery(document).ready(function () {
                ...
                if (window.location.href.indexOf('maium') > -1) {
                    Co2ok_JS().PlaceButton();
                    window.addEventListener('resize', (_) => Co2ok_JS().PlaceButton());
                }
                ...
                jQuery('.woocommerce-cart-form, .woocommerce form').find('input.qty').first().bind('change', function () {
                    if (window.location.href.indexOf('maium') == -1) {
                        ...
                        setTimeout(function () {
                            ...
                            const button = document.querySelector('.co2ok_container');
                        }, 200);
                    }
                });
