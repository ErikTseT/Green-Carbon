...
**WHMCS SSO**
The WordPress SSO (OAuth / OpenID Connect SSO) plugin supports login with WHMCS to allow users (clients, customers, workers, employees, technicians, etc) to access their WordPress portal based on their roles and capabilities. It also supports integration with other third-party plugins to sync the groups, courses, assignments, and tasks with the WHMCS SSO application.
