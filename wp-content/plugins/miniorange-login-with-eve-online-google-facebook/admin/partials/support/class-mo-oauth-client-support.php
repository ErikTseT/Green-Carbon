...
<div class="mo_enable_logs_wrapper mo_support_layout mo_oauth_outer_div">
	<div class="mo_cstm-addon-row">
		<div class="col-md-2 text-center">
			<img src="<?php echo esc_url( plugin_dir_url( __FILE__ ) ) . 'card-logo.png'; ?>">
		</div>
		<div class="col-md-10 text-dark mo_cstm-iframe">
			<h5 style="margin-top: 12px"><a class="mo_card-title"
	...
	<p class="mt-2 pl-2 mo_cstm-content">
	...
	<a class="mo_card-download-btn" href="https://wordpress.org/plugins/wp-rest-api-authentication/" target="_blank">Download
		Now</a>
</div>
		<?php
	}
