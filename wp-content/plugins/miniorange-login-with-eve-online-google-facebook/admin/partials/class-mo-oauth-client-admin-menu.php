...
<div class="mo_oauth_wrap" style="display:flex; justify-content: space-between">
	...
	<div class="mo_oauth_plugin_heading">
		...
		<a id="faq_button_id" class="add-new-h2 mo_generic-btns-on-top mo_oauth_header_link"
			href="https://faq.miniorange.com/kb/oauth-openid-connect/" target="_blank"><span>
			<img class="premium-img mo_oauth_header_link_image" src="<?php echo esc_url( dirname( plugin_dir_url( __FILE__ ) ) . '/images/troubleshooting.png' ); ?>"
				alt="miniOrange Troubleshooting Logo"><?php esc_html_e( 'Troubleshooting', 'miniorange-login-with-eve-online-google-facebook' ); ?></span></a>
