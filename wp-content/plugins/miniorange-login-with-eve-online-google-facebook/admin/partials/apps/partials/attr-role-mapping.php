			...
			<tr id="mo_oauth_email_attr_div">
				...
				<td>
					...
					if ( is_array( $attr_name_list ) ) {
						...
						?>
						<input class="mo_table_textbox" required="" placeholder="Enter attribute name for Username" type="text" id="mo_oauth_username_attr_input" name="mo_oauth_username_attr" value="
						<?php
