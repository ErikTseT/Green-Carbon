...
class MOOAuth {
	...
	*/
	...
	public function miniorange_oauth_save_settings() {
		...
		} elseif ( isset( $_POST['option'] ) && sanitize_text_field( wp_unslash( $_POST['option'] ) ) === 'mo_oauth_app_customization' && isset( $_REQUEST['mo_oauth_app_customization_form_field'] ) && wp_verify_nonce( sanitize_text_field( wp_unslash( $_REQUEST['mo_oauth_app_customization_form_field'] ) ), 'mo_oauth_app_customization_form' ) ) {

			if ( current_user_can( 'administrator' ) ) {
				$width  = ! empty( $_POST['mo_oauth_icon_width'] ) ? update_option( 'mo_oauth_icon_width', stripslashes( sanitize_text_field( wp_unslash( $_POST['mo_oauth_icon_width'] ) ) ) ) : '';
				$height = ! empty( $_POST['mo_oauth_icon_height'] ) ? update_option( 'mo_oauth_icon_height', stripslashes( sanitize_text_field( wp_unslash( $_POST['mo_oauth_icon_height'] ) ) ) ) : '';
				$margin = ! empty( $_POST['mo_oauth_icon_margin'] ) ? update_option( 'mo_oauth_icon_margin', stripslashes( sanitize_text_field( wp_unslash( $_POST['mo_oauth_icon_margin'] ) ) ) ) : '';
				$css    = ! empty( $_POST['mo_oauth_icon_configure_css'] ) ? update_option( 'mo_oauth_icon_configure_css', stripslashes( sanitize_text_field( wp_unslash( $_POST['mo_oauth_icon_configure_css'] ) ) ) ) : '';
